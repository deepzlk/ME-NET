...
from models.resnet import resnet14
import torch
import torch.nn as nn
import torch.nn.functional as F


# model_gen  = models.resnet18()
# #model_gen = vgg16.Vgg16_Net()
#
#
# print(model_gen)
...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = torch.cat([x1, out1], 1)
        out = self.shuffle(out)
        if self.is_last:
            return out1,out, preact
        else:
            return out
...
class ShuffleNetV2(nn.Module):
    ...
    def forward(self, x, is_feat=False, preact=False):
        ...
        f0 = out
        out1,out, f1_pre = self.layer1(out)
        f1 = out1
        f2 = out
        out1,out, f2_pre = self.layer2(out)
        f3 = out1
        f4 = out
        out1,out, f3_pre = self.layer3(out)
        f5 = out1
        f6= out
        ...
        if is_feat:
            if preact:
                ...
                return [f0, f1, f2, f3, f4, f5, f6, f7], out
        else:
            return out
